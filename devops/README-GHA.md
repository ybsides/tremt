...
2. Go to your repository at [ybsides/tremt](https://github.com/ybsides/tremt).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `tremt-ybsides.tangrama.com.br` and hit `Configure environment`.
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | tremt-ybsides.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/ybsides/tremt/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/ybsides/tremt/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/ybsides/tremt-backend`) and Frontend (`ghcr.io/ybsides/tremt-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of tremt-ybsides.tangrama.com.br](https://github.com/ybsides/tremt/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/tremt-ybsides.tangrama.com.br.yml` stack.
